...
public class RegexChallengeTest {
    ...
    @Test
    public void testL1() {
        check(RegexChallenge.L1, RegexChallengeTask.TASKS[0].automaton());
    }

    @Test
    public void testL2() {
        check(RegexChallenge.L2, RegexChallengeTask.TASKS[1].automaton());
    }

    @Test
    public void testRE1() {
        check(RegexChallenge.RE1, RegexChallengeTask.TASKS[2].automaton());
    }

    @Test
    public void testRE2() {
        check(RegexChallenge.RE2, RegexChallengeTask.TASKS[3].automaton());
    }

    @Test
    public void testRE3() {
        check(RegexChallenge.RE3, RegexChallengeTask.TASKS[4].automaton());
    }

    @Test
    public void testRE4() {
        check(RegexChallenge.RE4, RegexChallengeTask.TASKS[5].automaton());
    }
