...
public record RegexChallengeTask(String name, String description, Automaton automaton) {
    ...
    public static String[] getNames() {
        return Arrays.stream(TASKS).map(RegexChallengeTask::name).toArray(String[]::new);
    }
